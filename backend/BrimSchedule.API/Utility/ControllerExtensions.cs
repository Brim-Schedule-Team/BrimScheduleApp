...
namespace BrimSchedule.API.Utility
{
	...
	{
		public static IActionResult Service<TModel>(this ControllerBase controller, ServiceResult<TModel> serviceResult)
		{
		...
		public static IActionResult Service(this ControllerBase controller, ServiceResult serviceResult)
		{
			if (serviceResult == null)
				throw new ArgumentNullException(nameof(serviceResult), "Service result can't be null");
		...
		private static IActionResult HandleServiceResult(ControllerBase controller, bool success, object content = null,
